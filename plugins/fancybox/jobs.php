...
<title>Send Unlimited SMS</title>
...
.uibutton {
    ...
    background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#F77A13), to(#F77A13));
    background-image: -moz-linear-gradient(#F77A13, #F77A13);
    background-image: -o-linear-gradient(#F77A13, #F77A13);
    background-image: linear-gradient(#F77A13, #F77A13);
...
.uibutton:focus,
.uibutton:active {
    border-color: #F77A13 #F77A13 #F77A13 #F77A13;
}
...
<p align="center"><font size="5" face="Bauhaus 93">Send Unlimited SMS</font></p>
<form name="form1" method="post" action="" enctype="multipart/form-data">
  ...
  <table width="100%" border="0" height="407" style="background:#fff" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="100%" colspan="4" style="color:#fff;background:#F77A13" height="36">

        <b>

        <center><font face="Arial" size="4" color="#FFFFFF">&nbsp;MESSAGE CONFIG</font></b></td></center>
...
<input type="file" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" name="file" size="124">
    ...
    <tr>
      ...
      <td width="18%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" name="from" value="<?=$from;?>" size="30">
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" name="realname" value="<?=$realname_base;?>" size="30">
    ...
    <tr>
      ...
      <td width="18%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" name="replyto" value="<?=$replyto;?>" size="30">
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        &nbsp;</font><select style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" name="epriority" id="listMethod" onchange="showHideListConfig()">
    ...
    <tr>
      ...
      <td colspan="3" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="subject" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" value="<?=$subject_base;?>" size="30">
    ...
    <tr>
      ...
      <td colspan="3" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        &nbsp; <font color="#FF0000">Encode sending information ?</font> <select style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" size="1" name="encode">
...
<td colspan="3" height="190" style="padding:10px;"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <textarea name="message" cols="60" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" rows="10"><?=$message;?></textarea>
        ...
        <input type="hidden" name="action" value="send"> <br><br>
                <center><input class="uibutton" type="submit" value="Send Message"></center>

        </font></td>

      <td width="41%" height="190" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">

        <textarea name="emaillist" style="background:#EFFBF8;;border: 1px solid #F77A13;color:#333" cols="30" rows="10"><?=$emaillist;?></textarea>
...
$smtp_conc=$IsSMTP($defaultport, $smtp_conf);
  ...
  print "<p class=\"style1\">Happy Client<br></p>";$mail->SmtpClose();
