      ...
      <section id="main-content">
          <section class="wrapper">
			  ...
			  <div class="col-lg-6 col-md-offset-3 ">
                      <section class="panel" >
                          <header class="panel-heading text-center view_pro_color font_white3">
                              Change Your Picture
                          </header>
                        ...
                        while ($row = mysqli_fetch_assoc($sql)) {
                        		...
                        		//$t = '1';
                        ?>
                              <form  enctype="multipart/form-data" method="POST" role="form" action="" class="font_black2">
...
<?php 
    ...
    {		
        ...
        $ins=mysqli_query($con,"UPDATE `admin` SET
	...
	$link1="setting.php?adminid=$userid";
